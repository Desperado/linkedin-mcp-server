...
| `search_people` | Search for people by keywords, native location, connection degree (1st/2nd/3rd), and current company; a named location is selected in LinkedIn's People filter UI and must resolve to a native `geoUrn` before results are returned |
